...
target("example_simple")
    set_kind("binary")
    add_files("examples/example_simple.cpp")
    add_packages("quickjs-ng")

target("example_global")
    set_kind("binary")
    add_files("examples/example_global.cpp")
    add_packages("quickjs-ng")

target("example_value")
    set_kind("binary")
    add_files("examples/example_value.cpp")
    add_packages("quickjs-ng")
...
target("example_raylib")
    ...
    add_packages("quickjs-ng", "raylib")